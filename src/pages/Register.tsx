...
const RegisterPage = (props) => {
    ...
    return (
        ...
        <h2>Register</h2>
                ...
                <input style={inputStyles} value={confirmPassword} 
                        onChange={(e)=>setConfirm(e.target.value)} placeholder="***********"
                         name="cpassword" id="cpassword" type="password" />
                <div style={buttonContainerStyles}>
                    <BorderButton type='submit' text="Register"/>
                </div>
            </form>
            <button style={linkbuttonStyles} onClick={()=>{props.onFormSwitch('login')}}>Already have an account? Log in here </button>
         </div>
    )
}
