            ...
            <Row  style={heroStyle}>
                ...
                <motion.div
                  variants={containerl}
                    ...
                    viewport={{ once: true }}
                >
                    <HeaderComponent  maintext="WHOLETRADE PLATFORM" subtext="Make your bussiness smarter"/>
                    <div>
                        <p style={textStyles}> WholeTrade is multi-platform business software that manages your finances, automates workflows, and helps you work collectively across departments. </p> 
                    </div>
                </motion.div>
                </Col>
